...
# write to a json file the learned parameters -- priors, means, covariances, etc. 
...
class se3_class:
    ...
    # for each GMM component learn linear map 
    def _optimize(self):
    ...
    # simulate learned dS from initial pose to the attractor  -- should I use this? 
